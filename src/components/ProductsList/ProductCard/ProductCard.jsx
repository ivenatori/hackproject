...
const ProductCard = ({elem}) => {
    ...
    return (
        ...
        <div className='product_card'>
          ...
          {(user.email=='erlan@gmail.com'||user.email=='chingiz@gmail.com')&&<div><button onClick={(e)=>deleteProduct(elem.id)}>delete</button><button onClick={()=>setOpenModal(!openModal)}>edit</button></div>}
        {/* <div><IconButton
              size="large"
